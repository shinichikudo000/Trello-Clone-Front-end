...
export default function FeaturesContent() {
    const exploreFeaturesLink: navBarLinksType[] = [
        {
            name: 'Views',
        ...
        {
            name: 'Templates',
            description: 'Give your team a blueprint for success eith easy-to-use templates from industry leaders and the Trello community',
            link: '/templates',
        ...
        {
            name: 'Integrations',
            description: 'Find the apps your team is already using or discover new ways to get work done in Trello.',
            link: '/integrations'
        }
    ]
    return (
        <div className="flex w-full">
            <div className="pt-8 pb-[4.75rem] w-whiteContent">
                <div className="w-[640px] mr-[40px] lg:w-[760px] ml-auto pr-4 pl-2 flex flex-col items-start gap-4">
                    ...
                    <NavbarLinksContainer links={exploreFeaturesLink} />
                </div>
            </div>
