        ...
        <div className="flex w-full">
            <div className="pt-8 pb-[4.75rem] w-whiteContent">
                <div className="w-[640px] mr-[40px] lg:w-[760px] ml-auto pr-4 pl-2 flex flex-col items-start gap-4 text-[#505F79]">
                    ...
                    <ul className="flex flex-wrap w-[calc(100% + 2rem)] mx-[-1rem]">
                        <li className="w-1/3">
                            <Link href={'/teams/marketing'} className="w-full inline-block p-4">
                        ...
                        <li className="w-1/3">
                            <Link href={'/teams/design'} className="w-full inline-block p-4">
                                <div className="flex gap-2 mb-2">
                                    ...
                                    <h3 className="text-[#172B4D]">Design teams</h3>
                                </div>
                        ...
                        <li className="w-1/3">
                            <Link href={'/teams/startups'} className="w-full inline-block p-4">
                                <div className="flex gap-2 mb-2">
                                    ...
                                    <h3 className="text-[#172B4D]">Startups</h3>
                                </div>
                                <p className="text-xs">From hitting revenue goals to managing workflows, small businesses thrive with Trello.</p>
                            </Link>
                        </li>
                        <li className="w-1/3">
                            <Link href={'/teams/remote-team-management'} className="w-full inline-block p-4">
                                <div className="flex gap-2 mb-2">
                                    ...
                                    <h3 className="text-[#172B4D]">Remote Teams</h3>
                                </div>
                                ...
                                return (
                                    <li className="w-full group py-4">
                                        <Link key={index} href={link.link} className="w-full">
                                            <h3 className="text-base text-[#172B4D] flex">{link.name}
