            ...
            <section className="w-full bg-gradient-to-r from-[#403294] to-[#4C9AFF]">
                <div className="px-4 mx-auto w-full sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] md:flex">
                    <div className="w-full md:w-1/2 md:order-2 px-4 pt-[8rem] pb-4 md:pb-[5rem]">
                        <img src="//images.ctfassets.net/rz1oowkt5gyp/5VdMUyyLbdnF4kqGM5aORJ/646505ec4e9d9f91b9dc2b88198d5866/butler-header.svg" alt="automation-butler-header-img" className="w-full h-auto object-contain" />
                    </div>
            ...
            <section className="w-full">
                <div className="px-4 mx-auto w-full sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px]">
                    <div className="w-full text-center">
                        ...
                        <img src="//images.ctfassets.net/rz1oowkt5gyp/Wn1UM6FwcYkNYZHPzFDkX/11e151e55b277e5690c5b1742cd486a0/Illo-Flowchart.svg" alt="" className="w-full object-contain p-4" />
                    </div>
                ...
                <div className="px-4 mx-auto w-full sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px]">
                    <div className="w-full bg-gradient-to-t from-[#403294] to-[#172B4D] px-4 py-[5rem] text-white rounded-3xl text-center mb-[3rem]">
                        <ul className="w-full flex justify-center items-center flex-wrap p-4">
                            <li><img src="//images.ctfassets.net/rz1oowkt5gyp/5R2Z2uNm0syrV3SRka6U2h/f29d41f1c3e2eb55dbde443f07b4552d/coinbase_2x.png?w=323" alt='coinbase-logo' className="p-4 object-scale-down h-[4rem]" /></li>
                            <li><img src="//images.ctfassets.net/rz1oowkt5gyp/6siYQZNhk6oCQZSW7nDsZM/dd430f7c60496a4a4a86346ccdcc7f6a/JohnDeere.svg" alt='john-deere-logo' className="object-scale-down p-4"/></li>
                            <li><img src="//images.ctfassets.net/rz1oowkt5gyp/xsZg04XyKQXvIIfkvoF9k/c1e13a857ab867754c652c5da3e87504/Grand_Hyatt.svg" alt='grand-hyatt-logo' className="object-scale-down p-4 h-[4rem]" /></li>
                            <li><img src="//images.ctfassets.net/rz1oowkt5gyp/4mi0yTvx9p26OvEyGfpfqy/8148229f21c056ac0c381a6c1742842b/logo-google.svg" alt='google-logo' className="object-scale-down p-4" /></li> 
                        </ul>
                        <ul className="w-full flex justify-center items-center flex-wrap p-4">
                            <li><img src="//images.ctfassets.net/rz1oowkt5gyp/3iSGcJCdi0Nr69BbPjAGPb/25bea8a14c6f7a23560f83af07a30473/Visa.svg" alt='visa-logo' className="object-scale-down p-4" /></li>
                            <li><img src="//images.ctfassets.net/rz1oowkt5gyp/4MK9Mr07dtdg6iw0sF8bOs/2ed395aa78720d511c5893621c97f3c1/Zoom.png?w=249&fm=webp" alt='zoom-logo' className="object-scale-down p-4 h-[4rem]" /></li>
                        </ul>
